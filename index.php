<?php
  include_once 'app/GestorUsuario.php';
  $Usuario = GestorUsuario::CargarUsuario(101);
              ...
              <div class="d-flex justify-content-center form_container">
                <form  action=""  method="post">
                  ...
                  <div class="input-group mb-3">
                    <input type="text" name="cedula" id="cedula" class="form-control input_user" placeholder="Identficacion">
                  </div>
